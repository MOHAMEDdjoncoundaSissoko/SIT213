...
public class Simulateur {
    ...
    public  Simulateur(String [] args) throws ArgumentsException {
    	...
    	// création du transmetteur (canal parfait, sans bruit) et de la destination
    	...
    	// connexion des sondes d'affichage si demandé (-s)
    	if (affichage) {
    ...
    public float  calculTauxErreurBinaire() {
    	...
    	int nbBits = informationEmise.nbElements();
    	int nbErreurs = 0;
    	...
    	return (float) nbErreurs / (float) nbBits;
    }
